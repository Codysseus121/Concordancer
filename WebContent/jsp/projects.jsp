			...
			<c:choose>
					...
					<div class="card" style="width: 15rem;">
						...
						<div class="card-body">
							<button type="button" class="btn btn-primary btn-sm"
								data-toggle="modal" data-target="#newprojectmodal">Create
								Project</button>
				...
				<c:otherwise>
					...
					<c:forEach items="${sessionScope.projects}" var="Project">
						...
						<div id="${Project.project_id}" class="card "
							style="width: 15rem;">
							...
							<div class="card-body">
								<button type="submit" name="${Project.projectname}"
									id="${Project.project_id}" class="btn btn-primary btn-sm use">Use</button>

								<a href="#" name="${Project.projectname}"
									id="${Project.project_id}" data-toggle="modal"
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				<div class="modal-header" style="background-color:#ffd24c;">
					...
					<button type="button" class="close" name="submit" value="submit"
				...
				<div class="modal-body">
					<form method="post" id="newProject" enctype="multipart/form-data"
						action="/Concordancer/concordancer">
				...
				<div class="modal-content">
					...
					<div class="modal-footer" style="background-color:#ffd24c;">
						...
						<button type="button" class="btn btn-secondary close"
							data-dismiss="modal">Cancel</button>
						<input type="hidden" id="parameter_pid" name="parameter_pid"
							value="">
