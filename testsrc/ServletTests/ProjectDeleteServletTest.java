...
/**
 * Servlet implementation class ProjectDeleteServletTest
 */
@WebServlet("/ProjectDeleteServletTest")
public class ProjectDeleteServletTest extends Mockito {
	
       
	@Test
	public void testCorrectProjectDeletion() throws Exception {
		...
		when(request.getParameter("project_id")).thenReturn("163"); //Test an existing project_id & return true
	...
	@Test
	public void testFalseProjectDeletion() throws Exception {
